    ...
    <>
      <main className="bg-[#FAF7F2] sm:px-16  lg:px-96 w-screen  px-6 h-screen">
        <div className=" flex flex-row pt-5 pb-1 gap-28">
          ...
          <div className="text-xl md:pl-36 xl:pl-20 text-[#550509] font-bold">
            EEDC
          </div>
        </div>
        ...
        <div className="flex pt-24 flex-col gap-10">
          <div className="flex flex-col gap-2">
            ...
            <div className="h-[50px]  flex   ">
              <input
                className="w-full rounded-lg pb-2 flex-col px-2   bg-white pt-3"
                type="text"
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="h-[50px]  flex  ">
              <input
                className="pb-2 px-2 rounded-lg  flex-col w-full   bg-white pt-3"
                type="text"
                placeholder="0.00"
              />
            </div>
